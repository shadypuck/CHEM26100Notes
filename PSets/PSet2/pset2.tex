...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \begin{proof}[Answer]
            From the ground to the second-excited to the fourth-excited state, uncertainty in position increases slightly each time and uncertainty in momentum increases linearly.\par
            As $n\to\infty$, uncertainty in position will approach the asymptotic limit of $\frac{a}{2\sqrt{3}}$, but uncertainty in momentum will diverge to $\infty$.
        \end{proof}
    \end{enumerate}
