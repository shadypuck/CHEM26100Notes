...
\begin{enumerate}
    ...
    \begin{proof}[Answer]
        ...
        \end{align*}
        As per \textcite{bib:McQuarrieSimon}, the values are off by a factor of the IOR of air (1.00029) since \fbox{the calculation assumes a vacuum and the experimental value is measured in air.}
    \end{proof}
