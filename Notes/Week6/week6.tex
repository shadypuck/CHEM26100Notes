...
\begin{itemize}
    ...
    \end{itemize}
    \item \marginnote{11/13:}\textbf{Russell-Saunders coupling}: The result of determining the total angular momentum $\mathbf{L}$ and the total spin angular momentum $\mathbf{S}$ and then adding $\mathbf{L}$ and $\mathbf{S}$ together vectorially to obtain the total angular momentum $\mathbf{J}$.
