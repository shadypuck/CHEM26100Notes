...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \end{itemize}
    \end{itemize}
    \item Nuclear spins are not limited to $\pm 1/2$.
    \begin{itemize}
        \item \textcite{bib:McQuarrieSimon} lists the spin and some other properties of nuclei commonly studied with NMR.
    \end{itemize}
