...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Einstein proposes that the rate $-\dv*{N_1}{t}=\dv*{N_2}{t}$ of excitation from the ground electronic state to the excited electronic state is proportional to $\rho_v(\nu_{12})$ and $N_1(t)$. In particular,
        \begin{equation*}
            -\dv{N_1}{t} = B_{12}\rho_v(\nu_{12})N_1(t)
        \end{equation*}
    ...
    \end{itemize}
    \item \textbf{Spectral radiant energy density}: The radiant energy density per unit frequency. \emph{Denoted by} $\bm{\rho_v}$. \emph{Units} $\si{\joule\per\cubic\meter\second}$. \emph{Given by}
    \begin{equation*}
        \rho_v = \dv{\rho}{v}
    \end{equation*}
    ...
    \begin{itemize}
        \item The rate, we assume, is proportional to $N_2(t)$ and $\rho_v(\nu_{12})$. In particular,
        \begin{equation*}
            -\dv{N_2}{t} = B_{21}\rho_v(\nu_{12})N_2(t)
        \end{equation*}
    ...
    \begin{equation*}
        -\dv{N_1}{t} = \dv{N_2}{t} = B_{12}\rho_v(\nu_{12})N_1(t)-A_{21}N_2(t)-B_{21}\rho_v(\nu_{12})N_2(t)
    \end{equation*}
    \item Deriving a relation between the three Einstein coefficients.
    \begin{itemize}
        \item Consider the limit at which the two energy states are in thermal equilibrium, i.e., $-\dv*{N_1}{t}=\dv*{N_2}{t}=0$. Also let $\rho_v(\nu_{12})$ be the equilibrium spectral radiant energy density, which we assume comes from a thermal blackbody radiation source.
        \item Solving the above overall population rate of change equation for $\rho_v(\nu_{12})$ yields
        \begin{equation*}
    ...
    \begin{itemize}
        ...
        \begin{equation*}
            N_2(t) = \frac{B\rho_v(\nu_{12})N_\text{total}}{A+2B\rho_v(\nu_{12})}\{1-\e[-[{A+2B\rho_v(\nu_{12})]t}]\}
        \end{equation*}
        \item This equation's behavior as $t\to\infty$ converges to
        \begin{equation*}
            \frac{N_2}{N_\text{total}} = \frac{B\rho_v(\nu_{12})}{A+2B\rho_v(\nu_{12})}
        \end{equation*}
